...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate fresh Hubinet Ops 0.4.1 rollout telemetry"
    )
    ...
    try:
        ...
        print(
            f"Fresh 0.4.1 telemetry validation failed:\n"
    ...
    if errors:
        print(
            "Fresh 0.4.1 telemetry validation failed:\n" + "\n".join(errors),
            file=sys.stderr,
        )
        return 1
    return 0
