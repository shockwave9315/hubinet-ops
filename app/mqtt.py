...
def _ct_entities() -> list[tuple[str, str, str, dict[str, Any]]]:
    return [
        ...
        ("reboot_required", "Reboot required", "{{ 'yes' if value_json.reboot_required else 'no' }}", {}),
        ("packages_remaining_count", "Packages remaining", "{{ value_json.packages_remaining_count | default(0) }}", {}),
