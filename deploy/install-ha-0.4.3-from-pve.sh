...
BACKUP_DIR="/config/backups/hubinet-ops/${STAMP}-before-0.4.3"
...
python3 -m py_compile "$SOURCE_DIR/scripts/validate_ha_secrets_0_4_3.py"
...
ssh "${SSH_ARGS[@]}" 'cat /config/secrets.yaml' |
  python3 "$SOURCE_DIR/scripts/validate_ha_secrets_0_4_3.py" -
